...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    ...
    <select onchange="window.location.href='/gestor/frequencia_alunos.php?curso_id=' + this.value" class="w-full md:w-96 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500">
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <a href="/gestor/perfil_aluno.php?aluno_id=<?= $aluno['id'] ?>&curso_id=<?= $cursoSelecionado ?>" class="bg-blue-600 hover:bg-blue-700 text-white text-center py-2 rounded-lg text-sm transition">
                            Frequência
                        </a>
                    </div>
                </div>
