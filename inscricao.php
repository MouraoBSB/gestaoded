 ...
 *
 * Pagina de inscricao em curso (rota publica na raiz)
 */
...
?>
    <title>Inscrição - <?= htmlspecialchars($turma['curso_nome']) ?> - <?= htmlspecialchars($seoSiteTitle) ?></title>
<?= renderSeoMeta('Inscrição - ' . $turma['curso_nome'], $turma['curso_descricao'] ?? null) ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold" style="color: var(--cema-purple);">Centro Espírita Maria Madalena</h1>
                    </div>
                </div>
                <div class="flex items-center gap-6">
                    ...
                    <nav class="flex gap-6">
                        <a href="/" class="text-gray-700 hover:text-purple-600 font-medium transition">&larr; Voltar aos Cursos</a>
